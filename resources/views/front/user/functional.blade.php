        ...
        content-user-preview">
                    ...
                    <div class="col-7 pr-0">
                        <p>
                            ...
                            Поставьте перед собой цель и посмотрите, как Gym project может помочь вам преобразовать вашу
                            жизнь. Получите онлайн-доступ ко всем программам тренировок для любого телосложения и любого
                            уровня подготовки.
                    ...
                    <div class="col-7 pl-0 ">
                        ...
                        <div class=" col-12 p-0 d-flex align-items-center justify-content-center">
                            <div class="col-6">
                                ...
                                <ul>
                                    ...
                                    <li> — 20 разведений гантелей в стороны 3кг</li>
                                    <li> — 20 отжиманий</li>
                                    <li> — 5-7 мин.</li>
                                    <li> — 25 подтягивания на перекладине</li>
                                    <li> — Заминка 7 мин. (разтяжка)</li>

                                </ul>
                            </div>
                            <div class="col-6">
                                <div class="functional-training">
                                    <h2>Упражнения с резинкой для верхней части тела</h2>
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="25" cy="25" r="22.5" fill="#E21A3D"/>
                                        <path d="M20.834 17.7085V32.2918L32.2923 25.0002L20.834 17.7085Z" fill="white"/>
                        ...
                        <div class="col-12 d-flex p-0 flex-wrap youtube-comment">
                            ...
                            <div class="col-12 p-0">
                                ...
                                <p>Хотите похудеть? Привести свое тело в форму? Сжечь лишние калории? Поставьте перед
                                    собой цель и посмотрите, как Gym project может помочь вам преобразовать вашу жизнь.
