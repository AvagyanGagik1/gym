    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('admin.main.news.update',['id'=>$mainNew->id])}}" method="post"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Автор" class="form-control" id="author"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите цытата" class="form-control" id="quote_ru"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите цытата" class="form-control" id="quote_en"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите цытата" class="form-control" id="quote_blr"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Текст" class="form-control" id="text_ru"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Текст" class="form-control" id="text_en"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Текст" class="form-control" id="text_blr"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Заголовок Текста" class="form-control" id="text_title_ru"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Заголовок Текста" class="form-control" id="text_title_en"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Заголовок Текста" class="form-control" id="text_title_blr"
