    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('dietRestriction.update',$dietRestriction->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_ru" name="name_ru" value="{{$dietRestriction->name_ru}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_en" name="name_en" value="{{$dietRestriction->name_en}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_blr" name="name_blr" value="{{$dietRestriction->name_blr}}">
