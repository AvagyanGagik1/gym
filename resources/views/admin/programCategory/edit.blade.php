    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('programCategory.update',$programCategory->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_ru" name="name_ru" value="{{$programCategory->name_ru}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_en" name="name_en" value="{{$programCategory->name_en}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_blr" name="name_blr" value="{{$programCategory->name_blr}}">
            ...
            <div class="form-group row">
                <div class="btn-group">
                    ...
                    <a href="{{route('programCategory.index')}}" class="btn btn-danger">Назад</a>
                </div>
            </div>
        </form>
    </div>
