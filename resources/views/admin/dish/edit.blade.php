    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('dish.update',$dish->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_ru" name="name_ru" value="{{$dish->name_ru}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_en" name="name_en" value="{{$dish->name_en}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_blr" name="name_blr" value="{{$dish->name_blr}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="protein" name="protein" value="{{$dish->protein}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="protein" name="calories" value="{{$dish->calories}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="fats" name="fats" value="{{$dish->fats}}">
                    @if ($errors->has('fats'))
