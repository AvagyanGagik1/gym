    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('slider.text.update',['id'=>$sliderText->id])}}" method="post"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Текст слайдера" class="form-control" id="text_ru"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Текст слайдера" class="form-control" id="text_en"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Текст слайдера" class="form-control" id="text_blr"
