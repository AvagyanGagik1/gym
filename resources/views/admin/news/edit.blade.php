    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('news.update',$new->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{$new->title_ru}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="title_blr" name="title_blr" value="{{$new->title_blr}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="description_ru" class="editor" id="description_ru" cols="50" rows="10">{{$new->description_ru}}</textarea>
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="description_en" class="editor" id="description_en" cols="50" rows="10">{{$new->description_en}}</textarea>
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="description_blr" class="editor" id="description_blr" cols="50" rows="10">{{$new->description_blr}}</textarea>
