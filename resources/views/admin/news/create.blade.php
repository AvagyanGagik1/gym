    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('news.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Заголовок" type="text" class="form-control" id="title_ru" name="title_ru" value="{{old('title_ru')}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Заголовок" type="text" class="form-control" id="title_en" name="title_en" value="{{old('title_en')}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Заголовок" type="text" class="form-control" id="title_blr" name="title_blr" value="{{old('title_blr')}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Описаные" name="description_ru" class="editor" id="description_ru" cols="50" rows="10">{{old('description_ru')}}</textarea>
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Описаные" name="description_en" class="editor" id="description_en" cols="50" rows="10">{{old('description_en')}}</textarea>
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Описаные" name="description_blr" class="editor" id="description_blr" cols="50" rows="10">{{old('description_blr')}}</textarea>
