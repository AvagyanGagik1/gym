    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('trainer.update',$trainer->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Имя" type="text" class="form-control" id="name_ru" name="name_ru" value="{{$trainer->name_ru}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Имя" type="text" class="form-control" id="name_en" name="name_en" value="{{$trainer->name_en}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Имя" type="text" class="form-control" id="name_blr" name="name_blr" value="{{$trainer->name_blr}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input placeholder="Введите Профессию" type="text" class="form-control" id="profession_en" name="profession_en"
            ...
            <div class="form-group row">
                <div class="btn-group">
                    ...
                    <a href="{{route('trainer.index')}}" class="btn btn-danger">Отменить</a>
                </div>
            </div>
        </form>
    </div>
