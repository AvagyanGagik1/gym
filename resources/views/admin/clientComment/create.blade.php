    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('clientComment.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Введите Имя Пользавателья" id="user_name_ru" name="user_name_ru" value="{{old('user_name_ru')}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Введите Имя Пользавателья" id="user_name_en" name="user_name_en" value="{{old('user_name_en')}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Введите Имя Пользавателья" id="user_name_blr" name="user_name_blr" value="{{old('user_name_blr')}}">
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="text_ru" placeholder="Введите Комент" class="editor" id="text_ru" cols="50" rows="10">{{old('text_ru')}}</textarea>
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="text_en" placeholder="Введите Комент" class="editor" id="text_en" cols="50" rows="10">{{old('text_en')}}</textarea>
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="text_blr" placeholder="Введите Комент" class="editor" id="text_blr" cols="50" rows="10">{{old('text_blr')}}</textarea>
