    ...
    <div class="container border p-5 bg-white">
        ...
        <form action="{{route('admin.trainer.header.update',['id'=>$trainerHeader->id])}}" method="post"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Заголовок" class="form-control" id="title_ru"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Заголовок" class="form-control" id="title_en"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Заголовок" class="form-control" id="title_blr"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Описаные" class="form-control" id="description_ru"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Описаные" class="form-control" id="description_en"
            ...
            <div class="form-group row pb-3">
                ...
                <div class="col-sm-10">
                    <textarea placeholder="Введите Описаные" class="form-control" id="description_blr"
