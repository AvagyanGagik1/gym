...
<div id="app">
    <header>
        <nav class="mainNav">
            ...
            <div class="nav d-lg-flex d-none flex-nowrap align-items-center">
                <ul class="navList">
                    <li>
                ...
                <div class="dropdown d-none">
                    <button id="mainButtonResponsive" class=" btn d-none" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu" aria-labelledby="mainButtonResponsive">
                        ...
                        <a class="dropdown-item d-none"
                           href="#subscribe">{{__("language.subscriptionPrograms")}}</a>
